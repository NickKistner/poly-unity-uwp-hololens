...
namespace PolyToolkitInternal
{
    ...
    public static class AutoStringify
    {
        ...
        {
#if NETFX_CORE
            object[] attribs = info.GetCustomAttributes(typeof(AutoStringifyAbridged), inherit: true).ToArray();
#else
        ...
        {
#if NETFX_CORE
            object[] attribs = type.GetTypeInfo().GetCustomAttributes(attributeType, inherit: true).ToArray();
#else
